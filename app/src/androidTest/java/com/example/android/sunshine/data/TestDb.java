...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        Cursor weatherCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, //Table to query
                null, //all columns
        ...
        //Fifth Step: Validate data in resulting Cursor with the origina ContentValues

        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)

        TestUtilities.validateCurrentRecord("Error: Location Query Validation Failed", weatherCursor, weatherValues);
    ...
    public long insertLocation() {
        ...
        //Second Step: Create content values of what you want to insert
