...
public class WeatherContract {
    ...
    //content authority is the package name for the app, wich is guaranteed to be unique on the
    //device
    ...
    //For instance, content://com.example.android.sunshine/weather/ is a valid path for
    //looking at weather data, content://com.example.android.sunshine/givemeroot/ will fail,
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        //The location setting string is what will be sent to openthermap as the location query

        public static final String COLUMN_LOCATION_SETTING = "location_setting";

        //Human readable location string, provided by the API. Because for styling.
        //Palo Alto is more recognizable than 94306
